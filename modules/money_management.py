...
class CapitalManager:
    def __init__(self, currency, saving_margin, saving_threshold):
        self.currency = currency
        self.saving_threshold = saving_threshold
        self.saving_margin = saving_margin
    ...
    def get_capital_amounts(self):
        ...
        free_capital = capital * (1 - self.saving_margin) # defines the free capital as the capital available fro training once reduced by saving
        saving_capital = target_saving_capital = capital * self.saving_margin # capital to be put aside
